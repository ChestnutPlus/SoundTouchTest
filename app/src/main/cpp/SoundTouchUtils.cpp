...
extern "C" DLL_PUBLIC jstring Java_com_chestnut_SoundTouch_getVersionString(JNIEnv *env, jobject thiz)
{
    const char *verStr;
...
extern "C" DLL_PUBLIC jlong Java_com_chestnut_SoundTouch_SoundTouch_newInstance(JNIEnv *env, jobject thiz)
{
...
extern "C" DLL_PUBLIC void Java_com_chestnut_SoundTouch_SoundTouch_setTempo(JNIEnv *env, jobject thiz, jlong handle, jfloat tempo)
{
    SoundTouch *ptr = (SoundTouch*)handle;
    ptr->setTempo(tempo);
}
...
extern "C" DLL_PUBLIC void Java_com_chestnut_SoundTouch_SoundTouch_setPitchSemiTones(JNIEnv *env, jobject thiz, jlong handle, jfloat pitch)
{
    SoundTouch *ptr = (SoundTouch*)handle;
...
extern "C" DLL_PUBLIC void Java_com_chestnut_SoundTouch_SoundTouch_setSpeed(JNIEnv *env, jobject thiz, jlong handle, jfloat speed)
{
    SoundTouch *ptr = (SoundTouch*)handle;
    ptr->setRate(speed);
}
...
extern "C" DLL_PUBLIC jstring Java_com_chestnut_SoundTouch_getErrorString(JNIEnv *env, jobject thiz)
{
...
extern "C" DLL_PUBLIC int Java_com_chestnut_SoundTouch_SoundTouch_processFile(JNIEnv *env, jobject thiz, jlong handle, jstring jinputFile, jstring joutputFile)
{
    SoundTouch *ptr = (SoundTouch*)handle;
